...
class TestLoginUser:
    ...
    def test_login_user_code_200(self, generating_the_cour_and_delete_the_cour):
    ...
    def test_re_login_user_code_401(self, generating_the_cour_and_delete_the_cour):
        payload = {"name": generating_the_cour_and_delete_the_cour[0],
                   "email": generating_the_cour_and_delete_the_cour[1],
                   "password": generating_the_cour_and_delete_the_cour[2]}
        requests.post(f'{URL}{Endpoint.create_user}', data=payload)
    ...
    def test_login_user_with_incorrect_name_code_401(self, generating_the_cour_and_delete_the_cour):
        payload = {"name": generating_the_cour_and_delete_the_cour[0],
                   "email": generating_the_cour_and_delete_the_cour[1],
                   "password": generating_the_cour_and_delete_the_cour[2]}
        requests.post(f'{URL}{Endpoint.create_user}', data=payload)
    ...
    def test_login_user_with_incorrect_login_code_401(self, generating_the_cour_and_delete_the_cour):
        payload = {"name": generating_the_cour_and_delete_the_cour[0],
                   "email": generating_the_cour_and_delete_the_cour[1],
                   "password": generating_the_cour_and_delete_the_cour[2]}
        requests.post(f'{URL}{Endpoint.create_user}', data=payload)
    ...
    def test_login_user_with_incorrect_password_code_401(self, generating_the_cour_and_delete_the_cour):
        payload = {"name": generating_the_cour_and_delete_the_cour[0],
                   "email": generating_the_cour_and_delete_the_cour[1],
                   "password": generating_the_cour_and_delete_the_cour[2]}
        requests.post(f'{URL}{Endpoint.create_user}', data=payload)
    ...
    def test_login_user_without_field_name_code_401(self, generating_the_cour_and_delete_the_cour):
        payload = {"name": generating_the_cour_and_delete_the_cour[0],
                   "email": generating_the_cour_and_delete_the_cour[1],
                   "password": generating_the_cour_and_delete_the_cour[2]}
        requests.post(f'{URL}{Endpoint.create_user}', data=payload)
    ...
    def test_login_user_without_field_email_code_401(self, generating_the_cour_and_delete_the_cour):
        payload = {"name": generating_the_cour_and_delete_the_cour[0],
                   "email": generating_the_cour_and_delete_the_cour[1],
                   "password": generating_the_cour_and_delete_the_cour[2]}
        requests.post(f'{URL}{Endpoint.create_user}', data=payload)
    ...
    def test_login_user_without_field_password_code_401(self, generating_the_cour_and_delete_the_cour):
        payload = {"name": generating_the_cour_and_delete_the_cour[0],
                   "email": generating_the_cour_and_delete_the_cour[1],
                   "password": generating_the_cour_and_delete_the_cour[2]}
        requests.post(f'{URL}{Endpoint.create_user}', data=payload)
    ...
    def test_login_user_with_empty_request_body_code_401(self, generating_the_cour_and_delete_the_cour):
        payload = {"name": generating_the_cour_and_delete_the_cour[0],
                   "email": generating_the_cour_and_delete_the_cour[1],
                   "password": generating_the_cour_and_delete_the_cour[2]}
        requests.post(f'{URL}{Endpoint.create_user}', data=payload)
